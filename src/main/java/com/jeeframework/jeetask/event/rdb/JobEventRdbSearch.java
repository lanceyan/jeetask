...
import com.jeeframework.jeetask.event.type.JobExecutionEventThrowable;
...
//                        resultSet.getString(5), JobExecutionEvent.ExecutionSource.valueOf(resultSet.getString(6)),
