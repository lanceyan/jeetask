...
public final class JobNodeStorage {
    ...
    public JobNodeStorage(final CoordinatorRegistryCenter regCenter, String jobName) {
        this.regCenter = regCenter;
        jobNodePath = new JobNodePath(this.jobName);
    }
    ...
    private boolean isJobRootNodeExisted() {
        return regCenter.isExisted("/" + this.jobName);
    }
    ...
    public void addDataListener(final TreeCacheListener listener) {
        TreeCache cache = (TreeCache) regCenter.getRawCache("/" + this.jobName);
